...
if (!article.value) {
  throw createError({ statusCode: 404, statusMessage: '这似乎不是您要寻找的文章页面', fatal: true })
}
...
const socialLinks = computed(() => [{
  ...
  to: `https://www.linkedin.com/sharing/share-offsite/?url=https://crybabyaq.love${article.value._path}`
}, {
...
const links = [
  {
    ...
    label: '编辑此文章',
    to: `https://github.com/pacmandoh/pacdocs/edit/main/content/${article.value._file}`,
    target: '_blank'
  }, {
    ...
    label: '加入 Discord',
    to: 'https://discord.com/invite/pacdocs',
    target: '_blank'
  }
]
</script>
