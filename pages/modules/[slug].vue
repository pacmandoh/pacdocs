...
if (!module.value) {
  throw createError({ statusCode: 404, statusMessage: '这似乎不是您要寻找的 Nuxt 模块页面', fatal: true })
}
...
const description = module.value.description || 'Nuxt 模块'
useSeoMeta({
  titleTemplate: '%s · Nuxt 模块',
  title,
  description,
