<template>
  <Transition appear name="fade">
    ...
    >
      <div
        ref="el"
        class="absolute inset-0 grid justify-center auto-rows-auto -space-y-px"
      >
        ...
        <div class="absolute top-[calc(var(--rows)-var(--cell)*2+1px)] inset-x-0 h-[calc(var(--cell)*2)] bg-gradient-to-t from-white dark:from-gray-950 pointer-events-none" />
      </div>
    </div>
  </Transition>
</template>
