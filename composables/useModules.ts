...
const iconsMap = {
  分析: 'i-ph-chart-bar-duotone',
  CMS: 'i-ph-pencil-duotone',
  CSS: 'i-ph-paint-brush-broad-duotone',
  数据库: 'i-ph-database-duotone',
  开发者工具: 'i-ph-wrench-duotone',
  电子商务: 'i-ph-shopping-cart-duotone',
  扩展: 'i-ph-puzzle-piece-duotone',
  字体: 'i-ph-text-aa-duotone',
  图像: 'i-ph-image-duotone',
  图书库: 'i-ph-books-duotone',
  监控: 'i-ph-timer-duotone',
  支付: 'i-ph-credit-card-duotone',
  性能提升: 'i-ph-gauge-duotone',
  网络请求: 'i-ph-plugs-connected-duotone',
  安全: 'i-ph-shield-duotone',
